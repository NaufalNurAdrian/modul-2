export default function Contact() {
  return (
    <section
      id="contact"
      className="flex py-16 mt-20 min-h-screen bg-gradient-to-b from-blue-50 to-slate-100 text-gray-800"
    >
      <div className="max-w-5xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-12 items-center">
        {/* Bagian Informasi Kontak */}
        <div className="flex-1">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-center md:text-left text-blue-600">
            Contact Us
          </h2>
          <ul className="space-y-4 text-lg md:text-xl text-gray-700 text-center md:text-left">
            <li>📍 <span className="font-medium">Jakarta, Indonesia</span></li>
            <li>📞 <span className="font-medium">+62 812-3456-7890</span></li>
            <li>✉️ <span className="font-medium">contact@naufal-tech.com</span></li>
          </ul>
        </div>
